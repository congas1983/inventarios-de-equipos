<div class="panel panel-default">
	<div class="panel-body">
		...
		<div class="col-sm-8">
			{!!Form::open(['route' => 'buscar_empleado', 'role' => 'form', 'method' => 'GET'])!!}

				<div class="input-group">
                     
					<div class="input-group-addon">
						<input type="radio" name="campo" value="cedula" /> Cedula
					</div >
		...
		<div class="col-sm-3 col-sm-offset-1 text-right">
			<a href="{{route('crear_empleado')}}" class="btn btn-success btn-sm">
